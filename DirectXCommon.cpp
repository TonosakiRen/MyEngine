...
void DirectXCommon::CreateSwapChain() {
	...
	swapChainDesc.BufferCount = kNumFrameBuffers;//ダブルバッファ
...
void DirectXCommon::CreateFinalRenderTargets() {
	rtvHeap_ = CreateDescriptorHeap(D3D12_DESCRIPTOR_HEAP_TYPE_RTV, NumRTV, false);
	//RTVの設定
...
void DirectXCommon::CreateDepthBuffer() {
	dsvHeap_ = CreateDescriptorHeap(D3D12_DESCRIPTOR_HEAP_TYPE_DSV, NumDSV, false);
