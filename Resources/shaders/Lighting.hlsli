...
int32_t GetTileInformationIndex(float32_t2 pixelPos,TileNum tileNum){
	...
	float32_t2 texSize = float32_t2(1980,1080);
...
float32_t3 PointLightLighting(PointLight pointLight ,float32_t3 worldPos,float32_t3 viewDirection,float32_t3 normal,float32_t specluerPower){
...
float32_t3 SpotLightLighting(SpotLight spotLight ,float32_t3 worldPos,float32_t3 viewDirection,float32_t3 normal,float32_t specluerPower){
...
float32_t3 ShadowSpotLightLighting(ShadowSpotLight shadowSpotLight ,float32_t3 worldPos,float32_t3 viewDirection,float32_t3 normal,float32_t specluerPower){
...
float32_t3 DirectionalLightLighting(DirectionalLight directionalLight ,float32_t3 worldPos,float32_t3 viewDirection,float32_t3 normal,float32_t specluerPower){
...
float32_t3 AreaLightLighting(AreaLight areaLight ,float32_t3 worldPos,float32_t3 viewDirection,float32_t3 normal,float32_t specluerPower){
