...
void DeathParticle::Initialize(Vector3 minDirection, Vector3 maxDirection)
{
...
void DeathParticle::Draw(ViewProjection* viewProjection, DirectionalLight* directionalLight, Vector4 color)
{
