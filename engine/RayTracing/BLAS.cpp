...
void BLAS::Create(const std::wstring& name, const D3D12_RAYTRACING_GEOMETRY_DESC& geomDesc,CommandContext& commandContext) {
    ...
    scrach_.CreateResource(L"BlasSclachBuffer", CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT), CD3DX12_RESOURCE_DESC::Buffer(sizeof(info), D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS));
