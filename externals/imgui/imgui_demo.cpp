...
// In a real  you should be using PRId64 and PRIu64 from <inttypes.h> (non-windows) and on Windows define them yourself.
#ifdef _MSC_VER
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    // We only do it to make the demo s a little more welcoming, but typically this isn't required.
    ...
    if (ImGui::CollapsingHeader("Help"))
    {
        ...
        ImGui::BulletText("See example s in the examples/ folder.");
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Instruct Dear ImGui to render a mouse cursor itself. Note that a mouse cursor rendered via your  GPU rendering path will feel more laggy than hardware cursor, but will be more in sync with your other visuals.\n\nSome desktop s may use both kinds of cursors (e.g. enable software cursor only when resizing/dragging something).");
            ...
            ImGui::EndDisabled();
            ImGui::SameLine(); HelpMarker("First calls to Begin()/BeginChild() will return false.\n\nTHIS OPTION IS DISABLED because it needs to be set at  boot-time to make sense. Showing the disabled option is a way to make this feature easier to discover");
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("UTF-8 Text"))
        {
            ...
            //   Don't do this in your ! Please use u8"text in any language" in your !
    ...
    if (ImGui::TreeNode("Selectables"))
    {
        ...
        // The earlier is more flexible, as in real  your selection may be stored in many different ways
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        for (int line = 0; line < lines; line++)
        {
            ...
            // If you want to create your own time line for a real  you may be better off manipulating
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        if (ImGui::TreeNode("Outputs"))
        {
            HelpMarker(
                ...
                "to instruct your  of how to route inputs. Typically, when a value is true, it means "
                "Dear ImGui wants the corresponding inputs and we expect the underlying  to ignore them.\n\n"
                "The most typical case is: when hovering a window, Dear ImGui set io.WantCaptureMouse to true, "
                "and underlying  should ignore mouse inputs (in practice there are many and more subtle "
        ...
        if (ImGui::TreeNode("Mouse Cursors"))
        {
            ...
            ImGui::SameLine(); HelpMarker(
                "Your  can render a different mouse cursor based on what ImGui::GetMouseCursor() returns. "
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Colors"))
        {
            ...
            for (int i = 0; i < ImGuiCol_COUNT; i++)
            {
                ...
                {
                    // Tips: in a real user , you may want to merge and use an icon font into the main font,
        ...
        if (ImGui::BeginTabItem("Rendering"))
        {
            ...
            ImGui::DragFloat("Global Alpha", &style.Alpha, 0.005f, 0.20f, 1.0f, "%.2f"); // Not exposing zero here so user doesn't "lose" the UI (zero alpha clips all widgets). But  code could have a toggle to switch between zero and non-zero.
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        if (ImGui::BeginChild("ScrollingRegion", ImVec2(0, -footer_height_to_reserve), false, ImGuiWindowFlags_HorizontalScrollbar))
        {
            ...
            // A typical  wanting coarse clipping and filtering may want to pre-compute an array of indices
    ...
    void    Draw(const char* title, bool* p_open = NULL)
    {
        ...
        if (ImGui::BeginChild("scrolling", ImVec2(0, 0), false, ImGuiWindowFlags_HorizontalScrollbar))
        {
            ...
            if (Filter.IsActive())
            {
                ...
                // A real  processing logs with ten of thousands of entries may want to store the result of
